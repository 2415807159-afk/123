...
## 速览
**TLDR**：本研究针对电池电极材料在充放电过程中因离子嵌入导致的体积变化及机械应力问题，开发了一种高通量筛选工作流。该工作流利用机器学习模型预测键长，从而快速估算晶体结构的体积变化，克服了密度泛函理论（DFT）计算成本高的局限。通过对约117.5万种过渡金属氧化物和氟化物进行筛选并经DFT验证，该方法显著加速了低体积变化电池材料的发现过程。 \
**Motivation**：离子嵌入引起的体积变化会产生机械应力并损害电池循环稳定性，而传统的DFT计算在大规模筛选低体积变化材料时效率较低。 \
**Method**：开发了一种基于原子级特征和机器学习键长预测模型的工作流，通过学习局部配位环境与键长的关系来快速估算结构体积变化。 \
**Result**：成功对约117.5万种过渡金属氧化物和氟化物进行了高通量筛选，并通过DFT计算验证了其中最具潜力的候选材料。 \
**Conclusion**：该工作流提供了一种高效的预筛选机制，能够显著加速具有高结构稳定性的新型离子嵌入型电池材料的研发与发现。
