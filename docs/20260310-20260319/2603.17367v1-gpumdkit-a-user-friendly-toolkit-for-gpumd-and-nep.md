...
date: 2026-03-18
source: arxiv
link: "https://arxiv.org/abs/2603.17367v1"
tags: ["other:TiMD-ML"]
score: 10.0
...
motivation: 针对GPUMD和NEP在势场开发、主动学习及数据后处理过程中脚本编写复杂、学习曲线陡峭的问题。
method: 开发了模块化且可扩展的GPUMDkit工具包，提供涵盖模拟全流程的自动化功能及多种用户交互接口。
result: 实现了格式转换、结构采样、属性计算和数据可视化的一站式集成，大幅简化了复杂的模拟任务。
conclusion: GPUMDkit有效降低了GPUMD和NEP的使用门槛，是提升分子动力学模拟生产力的有力工具。
---
