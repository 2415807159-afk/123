...
tldr: 本研究利用飞行时间中能离子散射技术，实验观察了40 keV氙离子穿过自支撑单层石墨烯时的原子彩虹散射现象。结合分子动力学和二体碰撞近似模拟，研究揭示了石墨烯彩虹图样的构成：包括由多原子相互作用产生的六边形内彩虹，以及由单原子近距离二体碰撞产生的圆形外彩虹。该成果深化了对离子与二维材料相互作用机制的理解。
selection_source: fresh_fetch
motivation: 旨在通过实验观察和理论模拟，探究高能离子穿过单层石墨烯时的原子彩虹散射特性。
method: 采用飞行时间中能离子散射技术进行实验，并结合分子动力学和二体碰撞近似进行数值模拟。
result: 发现了由多原子相互作用形成的六边形内彩虹和由单原子二体碰撞形成的圆形外彩虹。
conclusion: 证实了石墨烯彩虹散射图样的双重特征，为研究离子与超薄材料的相互作用提供了新视角。
---

## 摘要
我们报道了利用飞行时间中能离子散射技术，对穿过自支撑单层石墨烯的 40 keV Xe$^+$ 离子进行的原子彩虹散射实验观测。在分子动力学和二体碰撞近似模拟的支持下，我们展示了石墨烯的彩虹图样由一个小的六边形内彩虹和一个较大的圆形外彩虹组成；前者源于具有特征轨迹的入射粒子与多个碳原子的相互作用，后者则源于入射粒子与单个碳原子之间的近距离二体碰撞。
