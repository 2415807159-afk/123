...
date: 2026-03-14
source: arxiv
link: "https://arxiv.org/abs/2603.14102v1"
tags: ["other:TiMD-ML"]
score: 9.335
...
## 摘要
稀有非绝热反应是许多重要分子过程的关键组成部分，但通过直接动力学模拟极具挑战。在本文中，我们将最近开发的映射面跳跃方法 (MASH) 与过渡路径采样相结合，构建了一个高效模拟这些稀有事件的框架。这之所以可行，是因为 MASH 轨迹具有马尔可夫性、时间可逆性并遵循刘维尔定理。该结合方法在不偏置底层动力学的情况下生成非绝热反应路径。所得系综允许对反应机制进行详细分析，并揭示包括速率常数在内的统计和动力学性质。我们应用该方法研究了在广泛的非绝热耦合强度范围内处于热平衡状态的自旋-玻色子模型。我们的结果表明，该方法为研究稀有非绝热过程提供了一个实用且系统的工具，其能力可能超出了暴力模拟的范围。
