...
tldr: 本研究针对石墨烯零带隙限制其光电应用的问题，利用密度泛函理论（DFT）和随时间变化的DFT（TDDFT）系统研究了硼氮（BN）环掺杂对金刚石形石墨烯量子点（GQDs）光电性质的影响。通过改变硼氮环的数量、位置和方向，分析了14种不同构型。研究发现，BN环掺杂能显著拓宽光吸收光谱，使其覆盖从红外到可见光区域，为石墨烯量子点的光电性能调控提供了有效途径。
selection_source: fresh_fetch
motivation: 针对石墨烯零带隙限制其在光电子领域应用的问题，探索通过硼氮杂原子掺杂来调控其光电性质。
method: 采用密度泛函理论（DFT）和随时间变化的DFT（TDDFT）对14种不同硼氮环掺杂构型的金刚石形石墨烯量子点进行几何、电子结构和光学性质研究。
result: 发现BN环的掺杂位置、数量和方向能显著影响能级结构，使光吸收光谱发生明显展宽并跨越红外至可见光波段。
conclusion: 系统性的BN环掺杂为石墨烯量子点的电子和光学性质提供了灵活的调控手段，在光电器件领域具有广阔的应用前景。
---
