...
## 速览
**TLDR**：针对铜/金刚石复合材料界面热导（ITC）较低的瓶颈，本研究提出了一种氮端基化策略。通过微调MACE机器学习原子间势能模型并结合晶格动力学模拟，发现氮端基化能使界面热导提升21%。研究揭示了氮端基通过表面质量修正和化学键调节来优化声子传输的机制，为提升复合材料散热性能提供了非金属改性的新思路。 \
**Motivation**：铜/金刚石界面热导较低限制了其在电子散热领域的应用，亟需有效的界面调控手段。 \
**Method**：基于MACE机器学习势能框架，通过微调预训练模型并结合晶格动力学模拟，研究氮端基对界面热传输的影响。 \
**Result**：氮端基化使铜/金刚石界面热导提升了21%，并选择性地调节了特定频率和波矢的纵声学（LA）声子。 \
