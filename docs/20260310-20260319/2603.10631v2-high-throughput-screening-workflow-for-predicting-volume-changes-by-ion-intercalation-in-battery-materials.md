...
## 速览
**TLDR**：本研究针对电池电极材料在充放电过程中因离子嵌入导致体积变化而引发的机械应力问题，提出了一种高通量筛选工作流。该工作流利用机器学习模型预测键长，进而估算晶体结构的体积变化，克服了密度泛函理论（DFT）计算成本高的局限。通过对约117.5万种过渡金属氧化物和氟化物进行筛选并经DFT验证，该方法显著加速了低体积变化电池材料的发现过程。 \
**Motivation**：离子嵌入引起的体积变化会产生机械应力并损害电池循环稳定性，而传统的DFT计算在大规模筛选中成本过高。 \
**Method**：开发了一种基于原子级特征和键长预测机器学习模型的工作流，利用局部配位环境的相似性来快速估算体积变化。 \
**Result**：成功对约117.5万种过渡金属氧化物和氟化物进行了高通量筛选，并通过DFT验证了其中最具潜力的候选材料。 \
**Conclusion**：该工作流能够有效过滤大规模候选材料集，显著加速了具有低体积变化特性的新型电池材料的发现。
