...
tldr: 本研究探讨了水中氢键网络对环境流动的阻力如何产生粘电应力和电致伸缩压力。研究者在昂萨格非平衡热力学框架下，结合电解质的点阵气体描述与氢键分子网络的粗粒度流体动力学表示，开发了统一的偶极泊松-能斯特-普朗克-斯托克斯（dPNP-S）连续介质理论。该模型成功复现了实验测得的粘电系数，揭示了氢键动力学影响电渗流的微观机制。
selection_source: fresh_fetch
motivation: 旨在揭示水中氢键网络动力学如何产生粘电应力并影响电渗流的微观机制。
method: 在昂萨格非平衡热力学框架下，将电解质的点阵气体模型与氢键网络的粗粒度流体动力学表示相结合，构建了dPNP-S连续介质理论。
result: 该理论定量复现了实验观测到的粘电系数和电致伸缩压力贡献。
conclusion: 研究确定了氢键网络动力学是影响电渗流的关键微观因素，为理解复杂流体的电渗效应提供了理论基础。
---
